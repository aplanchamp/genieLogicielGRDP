...
public class Atelier {
	...
	private String name, description, lieu, responsable, date, heure;
	private int nbPlace;
	
	public Atelier(String name, String description, String lieu, String responsable, String date, String heure,
			int nbPlace) {
		super();
		this.name = name;
